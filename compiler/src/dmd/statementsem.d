    ...
    void visitSynchronized(SynchronizedStatement ss)
    {
        ...
        if (ss.exp)
        {
            ...
            version (all)
            {
                ...
                args.push(new Parameter(Loc.initial, STC.none, ClassDeclaration.object.type, null, null, null, null));
        ...
        else
        {
            ...
            enterArgs.push(new Parameter(Loc.initial, STC.none, t.pointerTo(), null, null, null, null));
            ...
            exitArgs.push(new Parameter(Loc.initial, STC.none, t, null, null, null, null));
                                               ...
                                               Type tab, Scope* sc2, Type tn, Type tnv)
{
    ...
    dgparams.push(new Parameter(Loc.initial, STC.none, Type.tvoidptr, null, null, null, null));
    if (dim == 2)
        dgparams.push(new Parameter(Loc.initial, STC.none, Type.tvoidptr, null, null, null, null));
    dgty = new TypeDelegate(new TypeFunction(ParameterList(dgparams), Type.tint32, LINK.d));
    params.push(new Parameter(Loc.initial, STC.none, dgty, null, null, null, null));
...
private extern(D) Expression applyAssocArray(ForeachStatement fs, Expression flde, Type tab)
{
    ...
    {
        auto params = new Parameters();
        params.push(new Parameter(Loc.initial, STC.none, Type.tvoid.pointerTo(), null, null, null, null));
        ...
        params.push(new Parameter(Loc.initial, STC.none, fldeTy[i], null, null, null, null));
